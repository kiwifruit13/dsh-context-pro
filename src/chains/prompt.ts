...
export const CHAIN_PROTOCOL_SECTION = [
  ...
  '',
  '## 可选顶层字段（保留中文键与三态值，仅追加不改写）',
  'summary_sentence：一句话总结当前脉络（≤30字），与 nodes 内容一致，供压缩与跨轮接续读取。',
  'progress：仅操作链启用，{current_step,next_step,blocker}；用户说"继续"或询问与进度相关的内容时系统据此接续。',
  '',
